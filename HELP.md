...
* The original package name 'dk.michaelbui.ezbud-server' is invalid and this project uses 'dk.michaelbui.ezbud_server' instead.
...
* [JOOQ Access Layer](https://docs.spring.io/spring-boot/3.5.7/reference/data/sql.html#data.sql.jooq)
